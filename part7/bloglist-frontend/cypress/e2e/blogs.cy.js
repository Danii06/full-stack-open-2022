...
describe("When a blog exists", function () {
	...
	it("A blog can be deleted", function () {
		...
		cy.contains("What we owe to each other by T. M. Scanlon").should(
			"not.exist"
		)
	})
	...
	it("Blogs are sorted by likes", function () {
		...
		cy.get(".BlogTitleAuthor")
			.eq(0)
			.contains("Der Witz und seine Beziehung zum Unbewußten by Sigmund Freud")
		cy.get(".BlogTitleAuthor")
			.eq(1)
			.contains("What we owe to each other by T. M. Scanlon")
		cy.get(".BlogTitleAuthor")
			.eq(2)
			.contains(
